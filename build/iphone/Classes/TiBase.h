...
// in simulator we redefine to format for QuakeAware Developer console
...
{\
	NSString * exceptionName = [@"org.quakeaware." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.quakeaware";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIQuakeAwareNativeItemNone = -1, 
	UIQuakeAwareNativeItemSpinner = -2,
	UIQuakeAwareNativeItemProgressBar = -3,
	
	UIQuakeAwareNativeItemSlider = -4,
	UIQuakeAwareNativeItemSwitch = -5,
	UIQuakeAwareNativeItemMultiButton = -6,
	UIQuakeAwareNativeItemSegmented = -7,
	
	UIQuakeAwareNativeItemTextView = -8,
	UIQuakeAwareNativeItemTextField = -9,
	UIQuakeAwareNativeItemSearchBar = -10,
	
	UIQuakeAwareNativeItemPicker = -11,
	UIQuakeAwareNativeItemDatePicker = -12,
	
	UIQuakeAwareNativeItemInfoLight = -13,
	UIQuakeAwareNativeItemInfoDark = -14,
	
	UIQuakeAwareNativeItemDisclosure = -15,
	
	UIQuakeAwareNativeItemContactAdd = -16
};
